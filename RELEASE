[xde-theme-archlinux -- release notes.  2021-12-07]: #

Maintenance Release 1.2
=======================

This is the third release of the `xde-theme-archlinux` package.  This
...
[GitHub](https://github.com/bbidulock/xde-theme-archlinux/issues).
